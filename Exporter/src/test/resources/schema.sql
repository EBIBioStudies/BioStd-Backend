...
ALTER TABLE FileAttribute ADD CONSTRAINT FKek4om17ruuhrjo2gmirdxevay
...
CREATE INDEX FKc6qwpt1pjhskr2i0qut81jyes
    ON FileTagRef (tag_id);

CREATE INDEX FKjwy2goq7hgb8h6ha0cr4c7nc6
    ON FileTagRef (file_id);
...
CREATE INDEX FKb5uvg7lkkymi8cxuukfoq40jj
    ON GroupPermGrpACR (host_id);

CREATE INDEX FKfk0aeimcd84ghw6yqsvl4crmf
    ON GroupPermGrpACR (subject_id);
...
CREATE INDEX FKd5iloff3ys8vrdqfd0s2deuh
    ON GroupPermUsrACR (host_id);

CREATE INDEX FKgnlvyk3kl124e1sdx93kfrfe1
    ON GroupPermUsrACR (subject_id);
...
CREATE INDEX FK2ugnf9iqbbmc4uola613hi1ba
    ON GroupProfGrpACR (subject_id);

CREATE INDEX FKexss0gjarhk3g640cd59bwiso
    ON GroupProfGrpACR (profile_id);

CREATE INDEX FKpkcs62l0kqa4p7i3jpgqibe1
    ON GroupProfGrpACR (host_id);
...
CREATE INDEX FK48xq4my0foj1mdoxywmo8gndx
    ON GroupProfUsrACR (subject_id);

CREATE INDEX FKa5e9vbhh89jw9x0xi3s7j7kjd
    ON GroupProfUsrACR (profile_id);

CREATE INDEX FKo3kswy5ax5h6c6ao21ubdih8o
    ON GroupProfUsrACR (host_id);
...
CREATE INDEX FKjndkokb5qh9p1af7cim617rvv
    ON IdGen (counter_id);
...
CREATE INDEX FKeai1jrb5f522qfq70p3oq5ph5
    ON IdGenPermGrpACR (subject_id);

CREATE INDEX FKtnpsmccpwkr6l8vwphd8gll8r
    ON IdGenPermGrpACR (host_id);
...
CREATE INDEX FKbr7bcaanyb55175xmh4kducuy
    ON IdGenPermUsrACR (subject_id);

CREATE INDEX FKc318sg4w2yxt9yn5ousdruy25
    ON IdGenPermUsrACR (host_id);
...
CREATE INDEX FK1soo14x8o767oboi3k4xq6a75
    ON IdGenProfGrpACR (subject_id);

CREATE INDEX FK8if6oo32nulhyoyn08nc52135
    ON IdGenProfGrpACR (host_id);

CREATE INDEX FK9elcun29j9cp8duy2dcapiyta
    ON IdGenProfGrpACR (profile_id);
...
CREATE INDEX FK4p13ft5wvd0ysdlipfd5hx8ga
    ON IdGenProfUsrACR (host_id);

CREATE INDEX FKq9319jend4uh3jsq7ku5n9twp
    ON IdGenProfUsrACR (profile_id);

CREATE INDEX FKqm34wgkkt2ocpfa5xs3nkfgu5
    ON IdGenProfUsrACR (subject_id);
...
CREATE INDEX FKqhsnrwf0i6q08gt5l83fwchn8
    ON Link (section_id);
...
CREATE INDEX FKiy7ig2d3ubfsc921qrarw4x5n
    ON LinkAttribute (link_id);
...
CREATE INDEX FKlti8k5ohpaxww51g7ujyu96f6
    ON LinkAttributeTagRef (tag_id);

CREATE INDEX FKt2e1g7chbwfkbrsjvxtjfeidi
    ON LinkAttributeTagRef (attribute_id);
...
CREATE INDEX FKc0qu7988w42xxe7ypsmy5c242
    ON LinkTagRef (tag_id);

CREATE INDEX FKt4yfajuy06mokg9r2vdkeni1e
    ON LinkTagRef (link_id);
...
CREATE INDEX FKja1o6a442g9dmbouqehhuloxn
    ON Link_AccessTag (Link_id);

CREATE INDEX FKsiq98dra76i2ucsi7h7rkd3js
    ON Link_AccessTag (accessTags_id);
...
CREATE INDEX FKe9ry9gancqbvo7vpua4hhnhps
    ON Permission (host_id);

CREATE INDEX FKmydq52kdr5u8mah355qdc00qf
    ON Permission (subject_id);
...
ALTER TABLE CounterProfGrpACR
    ADD CONSTRAINT FKa17hrj8xmnbqvhi1p57jv1y1j
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE CounterProfUsrACR
    ADD CONSTRAINT FKeo5m46oqxt9xv3i8kglsdhumq
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE DelegateProfGrpACR
    ADD CONSTRAINT FK4s1js9suxjavjjj613tdd6sda
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE DelegateProfUsrACR
    ADD CONSTRAINT FKkwqiloo5m1x620t9hs8brvrm4
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE DomainProfGrpACR
    ADD CONSTRAINT FKih13oyxqkeix9osakex0yl1v3
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE DomainProfUsrACR
    ADD CONSTRAINT FK4qo9jt42qjg9tuun93yde795q
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE GroupProfGrpACR
    ADD CONSTRAINT FKexss0gjarhk3g640cd59bwiso
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE GroupProfUsrACR
    ADD CONSTRAINT FKa5e9vbhh89jw9x0xi3s7j7kjd
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE IdGenProfGrpACR
    ADD CONSTRAINT FK9elcun29j9cp8duy2dcapiyta
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);

ALTER TABLE IdGenProfUsrACR
    ADD CONSTRAINT FKq9319jend4uh3jsq7ku5n9twp
FOREIGN KEY (profile_id) REFERENCES PermissionProfile (id);
...
CREATE INDEX FKsiylfh5b67lymyxieyp8vt5i3
    ON PermissionProfile_Permission (PermissionProfile_id);
...
CREATE INDEX FKmahhiqqgllt6ljl6di8wg0gq3
    ON PermissionProfile_PermissionProfile (profiles_id);

CREATE INDEX FKou02v5l7x6l67pl8l145qilhu
    ON PermissionProfile_PermissionProfile (PermissionProfile_id);
...
CREATE INDEX acc_idx
    ON Section (accNo);

CREATE INDEX FK4bi0ld27mvrinwk6gleu9phf4
    ON Section (submission_id);

CREATE INDEX FKba6xolosvegauoq8xs1kj17ch
    ON Section (parent_id);

CREATE INDEX glob_idx
    ON Section (global);

CREATE INDEX section_type_index
    ON Section (type);

ALTER TABLE FileRef
    ADD CONSTRAINT FK464kkuexjpycuic1n33q0yhe2
FOREIGN KEY (sectionId) REFERENCES Section (id);

ALTER TABLE Link
    ADD CONSTRAINT FKqhsnrwf0i6q08gt5l83fwchn8
...
CREATE INDEX FK93fwpmt18ghb0hktnsljtlnhu
    ON SectionAttribute (section_id);
...
CREATE INDEX FK1cb21btg3gd8mkt44uuip4tw7
    ON SectionAttributeTagRef (attribute_id);

CREATE INDEX FKdemukuohsa90k3txsfvqq59f9
    ON SectionAttributeTagRef (tag_id);
...
CREATE INDEX FK9o566l9pdh34it8jchomb1s5d
    ON SectionTagRef (section_id);

CREATE INDEX FKi9bxyq49anoelbynx544y9dy
    ON SectionTagRef (tag_id);
...
CREATE INDEX FK8naal5ijvf4yiqsm61r4o0t38
    ON Section_AccessTag (Section_id);

CREATE INDEX FKdbupse53uebxuuafb22ti6b9d
    ON Section_AccessTag (accessTags_id);
...
CREATE INDEX FKhsm5gtat31dkrft0was3a7gr7
    ON Submission (rootSection_id);

CREATE INDEX FKidqs3m2ntuqyuiophfwikw81a
    ON Submission (owner_id);

CREATE INDEX released_idx
    ON Submission (released);

CREATE INDEX rtime_idx
    ON Submission (RTime);

ALTER TABLE AttributeSubscriptionMatchEvent
    ADD CONSTRAINT FKb13xop3ik6im4c9ibudfx7pu0
FOREIGN KEY (submission_id) REFERENCES Submission (id);

ALTER TABLE Section
    ADD CONSTRAINT FK4bi0ld27mvrinwk6gleu9phf4
FOREIGN KEY (submission_id) REFERENCES Submission (id);
...
CREATE INDEX FKstek2rbmsk052iydxt2eamv15
    ON SubmissionAttribute (submission_id);
...
CREATE INDEX FKp4d99wrvt56pcmh232bcqb39q
    ON SubmissionAttributeTagRef (attribute_id);

CREATE INDEX FKr6su7l8bywogputykgveyulpd
    ON SubmissionAttributeTagRef (tag_id);
...
CREATE INDEX FK4fb5yjdagkfeagoebhiloqqrp
    ON SubmissionTagRef (tag_id);

CREATE INDEX FK8hm6cswe1g8yln27i7io54q0q
    ON SubmissionTagRef (submission_id);
...
CREATE INDEX FK6kvcm7vgoutbie7um590vt5ev
    ON Submission_AccessTag (Submission_id);

CREATE INDEX FKgsgxljia12i17av51pl5el3c0
    ON Submission_AccessTag (accessTags_id);
...
CREATE INDEX FK3jv5jn809obpxl8owmq3cs7o5
    ON SystemPermGrpACR (subject_id);
...
CREATE INDEX FKtfti9r75r0drcn4gykuapf341
    ON SystemPermUsrACR (subject_id);
...
CREATE INDEX FK3davvbn9jm62fen9j2884iisw
    ON SystemProfGrpACR (profile_id);

CREATE INDEX FK8wbpwp547sycebpc4xqc0ikrg
    ON SystemProfGrpACR (subject_id);
...
CREATE INDEX FK2djtblr07v4l3kkp1jnhl5g1w
    ON TagPermUsrACR (subject_id);

CREATE INDEX FK6xcybyp33nxu74byne2krk6q8
    ON TagPermUsrACR (host_id);
...
CREATE INDEX FK8ukcmycyyw00rwjwqxqf1oya8
    ON TagProfGrpACR (profile_id);

CREATE INDEX FK8y3p3eqb28j5kehff9bwswsta
    ON TagProfGrpACR (host_id);

CREATE INDEX FKey1lxe9pspnvkajsd9ebntje4
    ON TagProfGrpACR (subject_id);
...
CREATE INDEX FK34re2b0uivh1xxrqp02gkhm2q
    ON TagProfUsrACR (host_id);

CREATE INDEX FKhswhutge4n1vvqf078nabcrrk
    ON TagProfUsrACR (subject_id);

CREATE INDEX FKtbpn3n25lmy7tigtb9s3n8h18
    ON TagProfUsrACR (profile_id);
...
CREATE INDEX tag_fk
    ON TagSubscription (tag_id);

CREATE INDEX user_fk
    ON TagSubscription (user_id);
...
CREATE INDEX FKiqlvauowjbb9na4lpcijjwx1r
    ON TagSubscriptionMatchEvent (user_id);

CREATE INDEX FKjpyitq19xx20cu269fxwa1x2m
    ON TagSubscriptionMatchEvent (subscription_id);

CREATE INDEX FKkhr4b0kpjuoa2m9u791efrrhp
    ON TagSubscriptionMatchEvent (submission_id);
...
CREATE INDEX FK72sqcoxks9xp8lv8aw03kf8o3
    ON TemplatePermGrpACR (subject_id);

CREATE INDEX FKng3hqrb8h40l2pcxrh46tuee3
    ON TemplatePermGrpACR (host_id);
...
CREATE INDEX FKj6s1ceas8cxveq6i24lcfmj13
    ON TemplatePermUsrACR (subject_id);

CREATE INDEX FKpjowt28229n8tojml209ayje3
    ON TemplatePermUsrACR (host_id);
...
CREATE INDEX FK23wwmxdclv2p9fo9gjxb98ydq
    ON TemplateProfGrpACR (host_id);

CREATE INDEX FK68m9cp82i31alwb0mcqiajluo
    ON TemplateProfGrpACR (subject_id);

CREATE INDEX FKcfy2byvhw4ubyt4q9i66dhdgi
    ON TemplateProfGrpACR (profile_id);
...
CREATE INDEX FK18ai9ee3c4lv0x4o9gctpripo
    ON TemplateProfUsrACR (host_id);

CREATE INDEX FK4ama6dl6dc9at8peysfdeo4o3
    ON TemplateProfUsrACR (profile_id);

CREATE INDEX FKflte3awcj10olkyjo7hlewiib
    ON TemplateProfUsrACR (subject_id);
...
ALTER TABLE AccessTag
    ADD CONSTRAINT FKc4d73kr6bf92cyioruykxptr0
FOREIGN KEY (owner_id) REFERENCES User (id);

ALTER TABLE AttributeSubscription
    ADD CONSTRAINT FKh8qytl1fxkrml09gigq7wf3et
FOREIGN KEY (user_id) REFERENCES User (id);

ALTER TABLE AttributeSubscriptionMatchEvent
    ADD CONSTRAINT FK7h9hi0w70d3hyuc9sqa7tya7o
FOREIGN KEY (user_id) REFERENCES User (id);

ALTER TABLE CounterPermUsrACR
    ADD CONSTRAINT FK3j5d4i1yqh2xunjg3el23mu9m
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE CounterProfUsrACR
    ADD CONSTRAINT FKj7i4xtr0qh73offslvyatva76
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE DelegatePermUsrACR
    ADD CONSTRAINT FKg3m1a2bcx37aoycmrhclniejd
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE DelegateProfUsrACR
    ADD CONSTRAINT FKtjpmgiy6509wrklnjq6xgvoo3
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE DomainPermUsrACR
    ADD CONSTRAINT FKe7i854txd6jxpmlr4gv8tiec5
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE DomainProfUsrACR
    ADD CONSTRAINT FK6af0e2y9y0tbcxb7h1m7hm3am
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE GroupPermUsrACR
    ADD CONSTRAINT FKgnlvyk3kl124e1sdx93kfrfe1
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE GroupProfUsrACR
    ADD CONSTRAINT FK48xq4my0foj1mdoxywmo8gndx
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE IdGenPermUsrACR
    ADD CONSTRAINT FKbr7bcaanyb55175xmh4kducuy
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE IdGenProfUsrACR
    ADD CONSTRAINT FKqm34wgkkt2ocpfa5xs3nkfgu5
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE Permission
    ADD CONSTRAINT FKcvw4cufrnbhv27xk1y9etsvdw
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE Submission
    ADD CONSTRAINT FKidqs3m2ntuqyuiophfwikw81a
FOREIGN KEY (owner_id) REFERENCES User (id);

ALTER TABLE SystemPermUsrACR
    ADD CONSTRAINT FKtfti9r75r0drcn4gykuapf341
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE SystemProfUsrACR
    ADD CONSTRAINT FKfbt2bpon4gx5qbo7j4q5km7bu
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE TagPermUsrACR
    ADD CONSTRAINT FK2djtblr07v4l3kkp1jnhl5g1w
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE TagProfUsrACR
    ADD CONSTRAINT FKhswhutge4n1vvqf078nabcrrk
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE TagSubscription
    ADD CONSTRAINT user_fk
FOREIGN KEY (user_id) REFERENCES User (id);

ALTER TABLE TagSubscriptionMatchEvent
    ADD CONSTRAINT FKiqlvauowjbb9na4lpcijjwx1r
FOREIGN KEY (user_id) REFERENCES User (id);

ALTER TABLE TemplatePermUsrACR
    ADD CONSTRAINT FKj6s1ceas8cxveq6i24lcfmj13
FOREIGN KEY (subject_id) REFERENCES User (id);

ALTER TABLE TemplateProfUsrACR
    ADD CONSTRAINT FKflte3awcj10olkyjo7hlewiib
FOREIGN KEY (subject_id) REFERENCES User (id);
...
CREATE INDEX FKt6580c8mqsfigvlgbtepcdnnk
    ON UserGroup (owner_id);

ALTER TABLE CounterPermGrpACR
    ADD CONSTRAINT FK5sf1bgxd91o0q80xdqqkecn8g
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE CounterProfGrpACR
    ADD CONSTRAINT FKoultj0eiyvf2g3694eb8jftfl
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE DelegatePermGrpACR
    ADD CONSTRAINT FK6hqac560pggme0ujt5f33yi6
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE DelegateProfGrpACR
    ADD CONSTRAINT FKbr37ya3yk2ieq3tju9rudfkq9
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE DomainPermGrpACR
    ADD CONSTRAINT FK4phx5icammt848odixjhc7ba7
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE DomainProfGrpACR
    ADD CONSTRAINT FKjatkxbassa6xkt3k2i34hhvx1
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE GroupPermGrpACR
    ADD CONSTRAINT FKfk0aeimcd84ghw6yqsvl4crmf
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE GroupPermGrpACR
    ADD CONSTRAINT FKb5uvg7lkkymi8cxuukfoq40jj
FOREIGN KEY (host_id) REFERENCES UserGroup (id);

ALTER TABLE GroupPermUsrACR
    ADD CONSTRAINT FKd5iloff3ys8vrdqfd0s2deuh
FOREIGN KEY (host_id) REFERENCES UserGroup (id);

ALTER TABLE GroupProfGrpACR
    ADD CONSTRAINT FK2ugnf9iqbbmc4uola613hi1ba
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE GroupProfGrpACR
    ADD CONSTRAINT FKpkcs62l0kqa4p7i3jpgqibe1
FOREIGN KEY (host_id) REFERENCES UserGroup (id);

ALTER TABLE GroupProfUsrACR
    ADD CONSTRAINT FKo3kswy5ax5h6c6ao21ubdih8o
FOREIGN KEY (host_id) REFERENCES UserGroup (id);

ALTER TABLE IdGenPermGrpACR
    ADD CONSTRAINT FKeai1jrb5f522qfq70p3oq5ph5
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE IdGenProfGrpACR
    ADD CONSTRAINT FK1soo14x8o767oboi3k4xq6a75
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE Permission
    ADD CONSTRAINT FKmydq52kdr5u8mah355qdc00qf
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);

ALTER TABLE SystemPermGrpACR
    ADD CONSTRAINT FK3jv5jn809obpxl8owmq3cs7o5
FOREIGN KEY (subject_id) REFERENCES UserGroup (id);
