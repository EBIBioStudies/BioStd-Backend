-- File list submission by AccNo configuration
...
-- File list submission by using list and referenced files
INSERT INTO Submission (CTime, MTime, RTime, accNo, relPath, released, rootPath, title, VERSION, secretKey, owner_id)
...
INSERT INTO ReferencedFile (name, size, fileListId, path)
...
UPDATE Section SET fileListId = 1 WHERE id = 1;
