...
public class StatsExportTest extends BaseIntegrationTest {
    ...
    private static final String EXPECTED_STATS_SUBMISSION_3 = "\"S-EPMC3343634\",\"0\",\"1\",\"9170140\",\"false\"";
    ...
    public void testStatsExport() throws Exception {
        assertStatsJob(EXPECTED_STATS_SUBMISSION_1, EXPECTED_STATS_SUBMISSION_2, EXPECTED_STATS_SUBMISSION_3);
    }
    ...
    public void testStatsExportNoImagingProjects() throws Exception {
        ...
        assertStatsJob(EXPECTED_STATS_SUBMISSION_1_NO_IMG, EXPECTED_STATS_SUBMISSION_2, EXPECTED_STATS_SUBMISSION_3);
    }
