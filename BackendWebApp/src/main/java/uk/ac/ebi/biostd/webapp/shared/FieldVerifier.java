 ...
 * package because we use it in both the client code and on the server. On the client, we verify that the name is valid
 ...
 * translatable and does not use native JavaScript. Code that is not translatable (such as code that interacts with a
